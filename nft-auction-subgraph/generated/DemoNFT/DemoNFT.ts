...
export class MintDemoCall extends ethereum.Call {
  ...
  get outputs(): MintDemoCall__Outputs {
    return new MintDemoCall__Outputs(this);
  }
}

export class MintDemoCall__Inputs {
  _call: MintDemoCall;

  constructor(call: MintDemoCall) {
    this._call = call;
  }
...
export class MintDemoCall__Outputs {
  _call: MintDemoCall;
